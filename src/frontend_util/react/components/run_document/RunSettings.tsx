  ...
  return (
    <>
      <div className="app_container mx-auto">
        ...
        {(state?.runDocument?.configuration?.rps || 0) > 50 && (
          <div role="alert" className="alert alert-warning cursor-pointer">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <span>
              Need more than 50 requests / second ? Click here to upgrade now
            </span>
          </div>
        )}
      </div>
