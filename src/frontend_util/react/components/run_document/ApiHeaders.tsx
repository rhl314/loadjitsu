...
export default function ApiHeaders(props: { apiStep: ApiStep, headerUpdated: ApiHeaderUpdated }) {
            ...
            <div className="row">
                <div className="col-12">
                    <table className="table">
                        ...
                        <tbody>
                            {
                                props.apiStep.headers.filter((header) => {
                                    ...
                                    return (
                                        <tr key={header.uniqueId}>
                                            ...
                                            }} type="checkbox" checked={header.active} /></th>
                                            <td><input autoFocus={autoFocusInput.keyUniqueId === header.uniqueId} onChange={(event: any) => {
                                                const updatedHeader = {
                                                ...
                                                props.headerUpdated(updatedHeader);
                                            }} className="form-control w-100 h-100" value={header.key} type="text" /></td>
                                            <td><input autoFocus={autoFocusInput.valueUniqueId === header.uniqueId} onChange={(event: any) => {
                                                const updatedHeader = {
                                                    ...header,
                                                    value: event?.target?.value,
                                                }
                                                props.headerUpdated(updatedHeader);
                                            }} className="form-control w-100 h-100" value={header.value} type="text" /></td>
