...
export default function ExecutionResults(props: { rows: IExecutionResultRow[] }) {
                ...
                <div className="col-12">
                    <ul className="nav nav-tabs">
                        <li className="nav-item d-flex">
                            <a className="nav-link active" href="#">Test runs</a>
                        </li>
                                    ...
                                    <div className="col-12 p-4" style={{ background: "black"}}>
                                        {
                                            executionResultData.map((data) => {
                                                return <ExecutionResultRow key={data.uniqueId} data={data}/>
                                            })
                                        }
                                    </div>
                                </div>
